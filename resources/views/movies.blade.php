...
<body class="bg-black min-h-screen font-sans">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4 md:space-x-8">
                    ...
                    <div class="hidden md:flex items-center space-x-4 md:space-x-6">
                        ...
                        <a href="{{ route('movies') }}" class="text-halloween-orange font-bold transition-colors duration-300">
                            Films
                        </a>
    ...
    <main class="pt-24 md:pt-28 pb-24 px-4 md:px-6">
        <div class="container mx-auto">
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="text-3xl md:text-5xl font-bold text-halloween-orange mb-4">
                    <i class="fas fa-film mr-3"></i>
                    Films
                </h1>
                <p class="text-text-secondary">{{ $movies->total() }} film(s) disponible(s)</p>
            </div>

            <!-- Filters -->
            <div class="bg-bg-secondary border-2 border-halloween-orange/30 rounded-2xl p-4 md:p-6 mb-8">
                <form method="GET" action="{{ route('movies') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <!-- Search -->
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full bg-bg-tertiary text-text-primary px-4 py-2 rounded-lg border border-halloween-orange/30 focus:border-halloween-orange focus:outline-none"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <select name="genre" class="w-full bg-bg-tertiary text-text-primary px-4 py-2 rounded-lg border border-halloween-orange/30 focus:border-halloween-orange focus:outline-none">
                    ...
                    <div>
                        ...
                        <select name="year" class="w-full bg-bg-tertiary text-text-primary px-4 py-2 rounded-lg border border-halloween-orange/30 focus:border-halloween-orange focus:outline-none">
                    ...
                    <div>
                        ...
                        <select name="sort" class="w-full bg-bg-tertiary text-text-primary px-4 py-2 rounded-lg border border-halloween-orange/30 focus:border-halloween-orange focus:outline-none">
                    ...
                    <div class="md:col-span-4 flex gap-2">
                        <button type="submit" class="bg-halloween-orange text-text-primary px-6 py-2 rounded-lg font-semibold hover:bg-halloween-orange-light transition-colors">
                            <i class="fas fa-filter mr-2"></i>
                            Filtrer
                        </button>
                        <a href="{{ route('movies') }}" class="bg-bg-tertiary text-text-primary px-6 py-2 rounded-lg font-semibold hover:bg-halloween-orange/20 transition-colors border border-halloween-orange/30">
                ...
                @if($movies->hasPages())
                    <div class="flex justify-center mt-8">
                        <div class="flex items-center space-x-2">
                            ...
                            @else
                                <a href="{{ $movies->appends(request()->except('page'))->previousPageUrl() }}" class="px-4 py-2 bg-halloween-orange text-text-primary rounded-lg hover:bg-halloween-orange-light transition-colors">
                                    <i class="fas fa-chevron-left"></i>
                                </a>
                            @endif

                            <span class="px-4 py-2 bg-bg-secondary text-text-primary rounded-lg border border-halloween-orange/30">
                                Page {{ $movies->currentPage() }} / {{ $movies->lastPage() }}
                            </span>

                            @if ($movies->hasMorePages())
                                <a href="{{ $movies->appends(request()->except('page'))->nextPageUrl() }}" class="px-4 py-2 bg-halloween-orange text-text-primary rounded-lg hover:bg-halloween-orange-light transition-colors">
            ...
            @else
                ...
                <div class="text-center py-16">
                    <i class="fas fa-film text-6xl text-halloween-orange/30 mb-6"></i>
                    <h2 class="text-2xl font-bold text-text-primary mb-4">Aucun film trouvé</h2>
                    <p class="text-text-secondary mb-8">Essayez de modifier vos filtres</p>
                    <a href="{{ route('movies') }}" class="inline-flex items-center bg-halloween-orange text-text-primary px-6 py-3 rounded-full font-bold hover:bg-halloween-orange-light transition-colors">
